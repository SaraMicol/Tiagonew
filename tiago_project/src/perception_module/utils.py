...
ENCODER_VITSAM_PATH = "/tiago_public_ws/src/tiago_project/src/perception_module/utils/l2_encoder.onnx"
DECODER_VITSAM_PATH = "/tiago_public_ws/src/tiago_project/src/perception_module/utils/l2_decoder.onnx"
